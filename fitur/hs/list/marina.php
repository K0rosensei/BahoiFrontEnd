...
<body>
  ...
  <div class="container">
    <div class="images">
      <img src="/bahoitourismv2/asset/homestay/Marina2.png" alt="Homestay Jein" class="main-image" />
      <div class="thumbnail-images">
        <img src="/bahoitourismv2/asset/homestay/Marina3.png" alt="Bedroom 1" class="thumbnail" />
        <img src="/bahoitourismv2/asset/homestay/Marina4.png" alt="Bedroom 2" class="thumbnail" />
      </div>
    </div>
    <div class="info">
      <div class="left">
        <h1>Homestay Marina</h1>
        <div class="rating-container">
          <span class="stars">★★★★☆</span>
          <span class="rating">4,8/5 (6 review)</span>
        </div>
      </div>
      <div class="right">
        <p class="price">
