...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <div class="images">
        <img
          src="/bahoitourismv2/asset/homestay/Amelia2.png"
          alt="Homestay Jein"
          class="main-image"
        />
      ...
      <div class="info-lainnya">
        ...
        <div class="section">
          <h3>
            <img
              src="/bahoitourismv2/asset/icon2/GivingTickets.png"
              alt="Ticket Icon"
              class="icon"
            />
            Penukaran Tiket
        ...
        <div class="section">
          <h3>
            <img
              src="/bahoitourismv2/asset/icon2/OrderCompleted.png"
              alt="Info Icon"
              class="icon"
            />
            Syarat & Ketentuan
        ...
        <div class="section">
          ...
          <div class="facilities">
            ...
            <div class="facility-item">
              <img
                src="/bahoitourismv2/asset/icon2/Noodles.png"
                alt="Breakfast Icon"
                class="icon"
              />
              <span>Sarapan</span>
